...
ansible-playbook -i ./truth_src.yml linux-playbook/centos7_post_installation.yml -vvv
ansible-playbook -i ./truth_src.yml linux-playbook/centos_minio_prerequisites.yml -vvv
ansible-playbook -i ./truth_src.yml idrac/get_sys_iv.yml -vvv
ansible-playbook -i ./truth_src.yml linux-playbook/centos_mount.yml -vvv
ansible-playbook -i ./truth_src.yml linux-playbook/centos_minio_setup.yml -vvv

ansible-playbook -i ./truth_src.yml linux-playbook/centos_roxywi.yml -vvv
ansible-playbook -i ./truth_src.yml linux-playbook/centos_roxywi_manual.yml -vv

#gather facts
ansible -i ./truth_src.yml minio -m ansible.builtin.setup
ansible -i ./truth_src.yml minio -m ping
ansible -i ./truth_src.yml minio -m shell -a 'ls /mnt'
ansible -i ./truth_src.yml minio -m shell -a 'lsblk -o name,mountpoint,label,size,uuid'
ansible -i ./truth_src.yml poweredge83 -m shell -a 'ls /usr/share/httpd/'
